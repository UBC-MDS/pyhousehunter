...
def test_scrape_clean_filter():
    assert int(filter.data_filter(cleaned_data, 10000, 15000, 500, 4, "")['price']) == 14000 


def test_full_integration():
    assert emailer.send_email(email_recipient = "elabandari@gmail.com", filtered_data=filtered_data, email_subject="Integration Test Success!") == None
